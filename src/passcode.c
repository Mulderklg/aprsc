...
#define kKey 0x73e2		// This is the default APRS key for the data
#define kKey_la 0x4C41		// This is the key for the data created for LizaAlert net
...
short aprs_passcode_la(const char* theCall)
{
	char rootCall[10];	// need to copy call to remove ssid from parse
	char *p1 = rootCall;
	...
	*p1 = 0;
	...
	short hash = kKey_la;		// Initialize with the key value
	short i = 0;
	short len = strlen(rootCall);
	char *ptr = rootCall;
